...
if ($_SESSION['user_type'] != 0) {
    header("Location: ../../registration/user/user_dashboard_secured.php");
    exit;
}
...
// שינוי: שימוש בשאילתה מוכנה (prepared statement) וטיפול בשגיאות
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (result.status === 'success') {
                                ...
                                // הפניה לדשבורד המשתמש לאחר 2 שניות
                                setTimeout(function() {
